...
sample_data(marmic)$Depth <- factor(sample_data(marmic)$Depth, levels = c("242", "308", "452", "817-862", "1120-1150"))
...
pdf("Fractional_abundance_a.pdf", width=24, height=14)
...
pdf("Fractional_abundance_b.pdf", width=24, height=14)
...
# Group
colors <- c("Fish" = "cornflowerblue", "Isopod" = "pink1", "Krill" = "red1", "Polychaete" = "goldenrod1", "Shrimp" = "maroon4", "Cephalopod" = "midnightblue", "Tunicate" = "cyan4")
# Species
...
p1 + scale_fill_manual(values = colors5, name="Median Depth (m)") + theme_classic() + geom_point(position=position_jitter(width=0, height=0), aes(fill = factor(Depth)), shape=21, color="gray32", size=3) + theme(text = element_text(size = 15))
dev.off()
...
p1 + theme_classic() + geom_point(position=position_jitter(width=0, height=0), aes(fill = factor(Depth), shape = Diet, color = factor(Depth)), size=3) + scale_shape_manual(values = c(19, 17, 15), name="Diet") + scale_fill_manual(values = colors5, name="Median Depth (m)", aesthetics = c("colour", "fill")) + theme(text = element_text(size = 15))
dev.off()
...
p3 + scale_fill_manual(values = colors5, name="Median Depth (m)") + theme_classic() + geom_point(position=position_jitter(width=0, height=0), aes(fill = factor(Depth)), shape=21, color="gray32", size=3) + theme(text = element_text(size = 15))
dev.off()
...
p3 + theme_classic() + geom_point(position=position_jitter(width=0, height=0), aes(fill = factor(Depth), shape = Diet, color = factor(Depth)), size=3) + scale_shape_manual(values = c(19, 17, 15), name="Diet") + scale_fill_manual(values = colors5, name="Median Depth (m)", aesthetics = c("colour", "fill")) + theme(text = element_text(size = 15))
dev.off()
